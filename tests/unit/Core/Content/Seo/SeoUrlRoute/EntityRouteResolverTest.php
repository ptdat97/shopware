...
class EntityRouteResolverTest extends TestCase
{
    ...
    private function createEntitySeoUrlRoute(string $entityName, string $routeName): EntitySeoUrlRouteInterface
    {
        $definition = static::createStub(EntityDefinition::class);
        $definition->method('getEntityName')->willReturn($entityName);

        $route = static::createStub(EntitySeoUrlRouteInterface::class);
        $route->method('getConfig')->willReturn(new SeoUrlRouteConfig($definition, $routeName, '{{ entity.name }}', true));
